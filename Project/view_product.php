...
<ul style="list-style: none; ">
    <li style="text-decoration: none;">
        <a href="addProduct.php" title="Add product" style="display: inline-block; padding: 10px 20px; text-decoration: none;
		 background-color: #4CAF50; color: white; border: 1px solid #4CAF50; border-radius: 5px;">Add Product</a>
        &nbsp;&nbsp;
        <a href="updateProduct.php" title="Restock items" style="display: inline-block; padding: 10px 20px; text-decoration: none; 
		background-color: #4CAF50; color: white; border: 1px solid #4CAF50; border-radius: 5px;">Update</a>
    </li>
</ul>
